...
const antTheme = {
  token: {
    ...
    lineHeight: 1.6,
    colorBorder: '#c8dac4',
    colorBorderSecondary: '#dbe9d7',
    boxShadow: '0 4px 16px rgba(25, 60, 64, 0.07), 0 2px 4px rgba(25, 60, 64, 0.04)',
    boxShadowSecondary: '0 1px 3px rgba(25, 60, 64, 0.06)',
  ...
  components: {
    Button: {
      ...
      fontWeight: 600,
      primaryShadow: '0 6px 20px rgba(46, 89, 2, 0.30)',
    },
    Card: {
      borderRadius: 18,
    ...
    Tabs: {
      borderRadius: 12,
      inkBarColor: '#2E5902',
      itemActiveColor: '#2E5902',
      itemSelectedColor: '#2E5902',
    },
